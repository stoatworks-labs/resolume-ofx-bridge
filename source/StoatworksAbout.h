/*
 * Stoatworks Labs - About window data for Resolume OFX Bridge.
 *
...
{
    inline constexpr auto name = "Resolume OFX Bridge";
    inline constexpr auto slug = "resolume-ofx-bridge";
    inline constexpr auto hook = "OpenFX plugins in Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/resolume-ofx-bridge/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/resolume-ofx-bridge/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/resolume-ofx-bridge";
    inline constexpr auto versionFallback = "v0.9.1";
